...
public class TbSysUser extends BaseDomain implements Serializable {
     ...
     * 序列号
     */
    private static final long serialVersionUID = -9116961525984129600L;
    ...
    /**
     * 获取管理员类型(0-非管理员 1-系统管理员 2-二级管理员)
     *
     * @return mgr_type - 管理员类型(0-非管理员 1-系统管理员 2-二级管理员)
     */
    ...
    /**
     * 设置管理员类型(0-非管理员 1-系统管理员 2-二级管理员)
     *
     * @param mgrType 管理员类型(0-非管理员 1-系统管理员 2-二级管理员)
     */
    ...
    /**
     * 获取密码安全级别(0-初始 1-很弱 2-弱 3-安全 4-很安全)
     *
     * @return pwd_security_level - 密码安全级别(0-初始 1-很弱 2-弱 3-安全 4-很安全)
     */
    ...
    /**
     * 设置密码安全级别(0-初始 1-很弱 2-弱 3-安全 4-很安全)
     *
     * @param pwdSecurityLevel 密码安全级别(0-初始 1-很弱 2-弱 3-安全 4-很安全)
     */
     ...
     * 获取密保问题修改时间
     *
     * @return pwd_quest_update_date - 密保问题修改时间
     */
     ...
     * 设置密保问题修改时间
     *
     * @param pwdQuestUpdateDate 密保问题修改时间
     */
    ...
    /**
     * 获取状态(0-正常 1-删除 2-停用 3-冻结)
     *
     * @return status - 状态(0-正常 1-删除 2-停用 3-冻结)
     */
    ...
    /**
     * 设置状态(0-正常 1-删除 2-停用 3-冻结)
     *
     * @param status 状态(0-正常 1-删除 2-停用 3-冻结)
     */
