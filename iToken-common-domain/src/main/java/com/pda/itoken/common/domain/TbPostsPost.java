...
public class TbPostsPost extends BaseDomain implements Serializable {
    ...
    /**
     * 文章状态(0-草稿 1-已发布的文章 2-待审核的文章 3-被拒绝的文章 4-定时发布的文章)
     */
    ...
    /**
     * 获取文章状态(0-草稿 1-已发布的文章 2-待审核的文章 3-被拒绝的文章 4-定时发布的文章)
     *
     * @return status - 文章状态(0-草稿 1-已发布的文章 2-待审核的文章 3-被拒绝的文章 4-定时发布的文章)
     */
    ...
    /**
     * 设置文章状态(0-草稿 1-已发布的文章 2-待审核的文章 3-被拒绝的文章 4-定时发布的文章)
     *
     * @param status 文章状态(0-草稿 1-已发布的文章 2-待审核的文章 3-被拒绝的文章 4-定时发布的文章)
     */
    ...
    /**
     * 获取文章的阅读权限(0-无限制 1-会员)
     *
     * @return access - 文章的阅读权限(0-无限制 1-会员)
     */
    ...
    /**
     * 设置文章的阅读权限(0-无限制 1-会员)
     *
     * @param access 文章的阅读权限(0-无限制 1-会员)
     */
     ...
     * 获取裁剪后不带尺寸的正文图片数组
     *
     * @return original_image - 裁剪后不带尺寸的正文图片数组
     */
     ...
     * 设置裁剪后不带尺寸的正文图片数组
     *
     * @param originalImage 裁剪后不带尺寸的正文图片数组
     */
     ...
     * 获取裁剪前的正文图片数组
     *
     * @return full_size_image - 裁剪前的正文图片数组
     */
     ...
     * 设置裁剪前的正文图片数组
     *
     * @param fullSizeImage 裁剪前的正文图片数组
     */
